...
export default function DemographicsPage() {
  ...
  const saveDemographicsToFirestore = async (
    ...
    if (!userId) {
      toast({
        title: "Error",
        description: "User ID missing. Cannot save demographics to database.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        title: "Save Error",
        description: `Could not save demographic info to database. It's saved locally. ${
      ...
      <main className="w-full max-w-lg space-y-8">
        <Card className="shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Please provide some basic information. This data is anonymized and
